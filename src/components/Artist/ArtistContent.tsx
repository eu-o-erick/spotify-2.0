    ...
    <section className="container">
      ...
      {seeAllResulst && (
        <div className="container -mt-6 pb-24 flex flex-col items-end max-sm:-mt-8 max-sm:pb-20">
          <Link
            className="md:hover:underline opacity-60 md:hover:opacity-90 max-md:active:underline max-md:active:opacity-100 transition-all max-md:px-2 max-sm:text-xs"
            href={{
