        ...
        {isLoading && (
          <div className="relative animate-pulse w-full flex gap-6 max-sm:flex-col max-sm:gap-4">
            ...
            <div className="flex flex-1 flex-col justify-end max-sm:py-0">
              <div className="bg-secondary rounded-[4px] h-9 w-56 max-lg:h-7 max-lg:w-44 max-sm:h-6 max-sm:w-40" />

              <div className="flex flex-col gap-5 mt-3 max-lg:mt-2 max-lg:gap-3 max-sm:gap-2.5  max-sm:mt-3 max-sm:flex-col-reverse">
        ...
        {!isLoading && dataAlbum && (
          <Fragment>
            ...
            <SpotifyButton
              ...
              className="absolute bottom-11 max-lg:bottom-auto max-lg:top-16 right-0 max-sm:top-8 max-sm:right-3"
            />
          </Fragment>
        )}
      </div>
